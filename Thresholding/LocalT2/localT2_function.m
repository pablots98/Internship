function [adjusted_matrix, expression_scoreMatrix] = localT2_function(mappedDat, unpruneddata, lowerThres, upperThres)
...
% - expression_scoreMatrix: Gene specific local threshold normalized
% expression per gene.
%
